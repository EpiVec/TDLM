...
test_that("class TDLM", {
  ...
  res <- run_law(law = "Unif", mass_origin = mi, mass_destination = NULL, distance = NULL, opportunity = NULL, param = 0.1,
                 check_names = TRUE)
...
test_that("check errors", {
  ...
  expect_error(run_law(law = "Uni", mass_origin = mi, mass_destination = NULL, distance = NULL, opportunity = NULL, param = 0.1,
                       check_names = TRUE), 
